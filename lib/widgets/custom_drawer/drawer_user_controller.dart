                ...
                child: Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      // AppBar modifications start here
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              // Centered Logo - only visible when drawer is closed
                              AnimatedOpacity(
                                opacity: scrolloffset == 0.0 ? 1.0 : 0.0,
                                duration: Duration(milliseconds: 250),
                                child: Center(child: logoWidget),
                              ),

                              // Notification Icon Button - aligned to the right, only visible when drawer is closed
                              AnimatedOpacity(
                                opacity: scrolloffset == 0.0 ? 1.0 : 0.0,
                                duration: Duration(milliseconds: 250),
                                child: Align(
