...
import 'package:pyramids_developments/screens/Feed/popular_filter_list.dart';
              ...
              child: Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      //update list
                      // Gather selected accommodation types
                      List<String> selectedTypes = accomodationListData
                          .where((element) => element.isSelected)
                          .map((e) => e.titleTxt)
                          .toList();

                      // Create a FilterResult object
                      FilterResult result = FilterResult(selectedAccommodationTypes: selectedTypes);
